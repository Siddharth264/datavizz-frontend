...
export default function LeftBar() {
  ...
  return (
    <div className="flex min-h-screen w-full">
      <aside className="flex h-full w-64 flex-col border-r bg-[#ffffff]">
        ...
        <div className="flex flex-1 flex-col overflow-y-auto px-2 py-4">
          <nav className="space-y-1">
            <Link
              href="/"
              className="flex cursor-pointer bg-[#B6EBE2] items-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-muted hover:text-foreground"
              prefetch={false}
            >
          ...
          <div className="px-3 py-2">
            <Input type="search" placeholder="Search..." className="w-full rounded-md bg-muted px-3 py-2 text-sm" />
          </div>
        </div>
      </aside>
